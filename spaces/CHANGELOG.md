...
All notable changes to **webdeck-spaces**. The app version is baked into every
...
The format (`webdeck-spaces`, version `1`) is additive and stable — every version
...
- **Password protection, autosave and recovery, signed self-update** —
  the platform guarantees, on the same terms as webdeck.
